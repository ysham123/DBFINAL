...
const assetOrigin = new URL(API_URL, window.location.origin).origin;
export const photoUrl = (path) => new URL(path, assetOrigin).href;
...
export const quoteAPI = {
  ...
  respondToQuote: (quoteId, data) =>
    api.patch(`/quotes/${quoteId}/respond`, data),
};
...
export const orderAPI = {
  ...
  updateStatus: (id, status) =>
    api.patch(`/orders/${id}/status`, { completion_status: status }),
};
...
export const dashboardAPI = {
  ...
  getAcceptedQuotes: (year, month) =>
    api.get("/dashboard/accepted-quotes", { params: { year, month } }),
